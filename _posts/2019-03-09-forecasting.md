...
![ACF and PACF]({{ site.baseurl }}/assets/images/forecast/2.jpg){:height="460px" width="700px"}{:class="image-centered"}
...
![two models]({{ site.baseurl }}/assets/images/forecast/4.jpg){:height="250px" width="400px"}{:class="image-centered"}
